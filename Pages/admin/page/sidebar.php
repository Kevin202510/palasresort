...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header"style="margin-top:10px">
      ...
      <a class href="index.php"><img src="./assets/img/p1.jpg" style="width: 75px;height: 63px;margin-top:30px;margin-left:10px"alt=""><img src="./assets/img/pals.png"style="margin-top:30px;;width: 150px;height: 70px"alt=""></a>
      ...
      <ul class="navbar-nav"style="margin-top:50px">
        ...
        <li class="nav-item">
          <a class="nav-link " href="sales.php">
            ...
            <span class="nav-link-text ms-1" style="color:#987554;font-family : bradley hand, cursive"><b>Sales</b></span>
          </a>
        </li>
